class Solution {
    ...
    public String[] spellchecker(String[] wordlist, String[] queries) {
        ...
        for (String word : wordlist) {
            ...
            caseMap.putIfAbsent(lowerWord, word); // keeping only 1st occurence
        ...
        for (int i = 0; i < queries.length; i++) {
            ans[i] = checkForMatch(queries[i]);
        }
        return ans;
    }
}
/**
TC = O(n) -> n = total length of all input strings and queries
SC = O(n) */